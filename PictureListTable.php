...
class PictureListTable extends WP_List_Table {
	...
	public function __construct() {
		...
		parent::__construct( [
			'singular' => __( 'Picture', 'sp' ), //singular name of the listed records
			'plural'   => __( 'Pictures', 'sp' ), //plural name of the listed records
	...
	public function get_bulk_actions() {
		$actions = [
			'bulk-delete'       => 'Delete',
			'bulk-change-alt'   => 'Change Alt',
			'random-change-alt' => 'Random Change Alt'
